...
if(MSVC)
    set_target_properties(libSDL2 PROPERTIES
            IMPORTED_LOCATION "${DEPENDENCIES_ROOT}/SDL2/bin/${CMAKE_SHARED_LIBRARY_PREFIX}SDL2${CMAKE_SHARED_LIBRARY_SUFFIX}"
            IMPORTED_IMPLIB "${DEPENDENCIES_ROOT}/SDL2/lib/${CMAKE_STATIC_LIBRARY_PREFIX}SDL2${CMAKE_STATIC_LIBRARY_SUFFIX}"
            IMPORTED_LOCATION_DEBUG "${DEPENDENCIES_ROOT}/SDL2/bin/${CMAKE_SHARED_LIBRARY_PREFIX}SDL2d${CMAKE_SHARED_LIBRARY_SUFFIX}"
...
ExternalProject_Add(Bullet3
        ...
        CMAKE_ARGS "-DCMAKE_INSTALL_PREFIX=${DEPENDENCIES_ROOT}/bullet3" -DINSTALL_LIBS=ON -DBUILD_CPU_DEMOS=OFF -DBUILD_PYBULLET=OFF -DBUILD_ENET=OFF -DBUILD_CLSOCKET=OFF -DBUILD_OPENGL3_DEMOS=OFF -DBUILD_BULLET2_DEMOS=OFF -DBUILD_EXTRAS=OFF -DBUILD_UNIT_TESTS=OFF -DINSTALL_CMAKE_FILES=OFF -DUSE_GRAPHICAL_BENCHMARK=OFF
...
if(MSVC)
        MESSAGE("${DEPENDENCIES_ROOT}/bullet3/lib/Bullet3Collision_Debug${CMAKE_STATIC_LIBRARY_SUFFIX}")
	set_target_properties(libBullet3Common PROPERTIES
			IMPORTED_LOCATION "${DEPENDENCIES_ROOT}/bullet3/lib/Bullet3Common${CMAKE_STATIC_LIBRARY_SUFFIX}"
			IMPORTED_LOCATION_DEBUG "${DEPENDENCIES_ROOT}/bullet3/lib/Bullet3Common_Debug${CMAKE_STATIC_LIBRARY_SUFFIX}"
			INTERFACE_INCLUDE_DIRECTORIES "${DEPENDENCIES_ROOT}/bullet3/include")
	set_target_properties(libBullet3Collision PROPERTIES
			IMPORTED_LOCATION "${DEPENDENCIES_ROOT}/bullet3/lib/Bullet3Collision${CMAKE_STATIC_LIBRARY_SUFFIX}"
			IMPORTED_LOCATION_DEBUG "${DEPENDENCIES_ROOT}/bullet3/lib/Bullet3Collision_Debug${CMAKE_STATIC_LIBRARY_SUFFIX}"
			INTERFACE_INCLUDE_DIRECTORIES "${DEPENDENCIES_ROOT}/bullet3/include")
	set_target_properties(libBullet3Dynamics PROPERTIES
			IMPORTED_LOCATION "${DEPENDENCIES_ROOT}/bullet3/lib/Bullet3Dynamics${CMAKE_STATIC_LIBRARY_SUFFIX}"
			IMPORTED_LOCATION_DEBUG "${DEPENDENCIES_ROOT}/bullet3/lib/Bullet3Dynamics_Debug${CMAKE_STATIC_LIBRARY_SUFFIX}"
			INTERFACE_INCLUDE_DIRECTORIES "${DEPENDENCIES_ROOT}/bullet3/include")
else()
	set_target_properties(libBullet3Common PROPERTIES
...
if(MSVC)
	set_target_properties(libZlib PROPERTIES
			              IMPORTED_LOCATION "${DEPENDENCIES_ROOT}/zlib/lib/${CMAKE_STATIC_LIBRARY_PREFIX}zlibstatic${CMAKE_STATIC_LIBRARY_SUFFIX}"
			              IMPORTED_LOCATION_DEBUG "${DEPENDENCIES_ROOT}/zlib/lib/${CMAKE_STATIC_LIBRARY_PREFIX}zlibstaticd${CMAKE_STATIC_LIBRARY_SUFFIX}"
